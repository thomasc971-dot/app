...
import { Search, ArrowRight, ChevronDown, ChevronUp, Flame } from "lucide-react";
...
function FilterBar({ secteurs, secteur, onSelect }) {
  ...
  const shown = showAll ? secteurs : secteurs.slice(0, VISIBLE_FILTERS);
          ...
          {hidden > 0 && (
            ...
            >
              {showAll ? (
                ...
                <>Voir plus ({hidden}) <ChevronDown size={14} /></>
              )}
            </button>
          )}
        </div>
